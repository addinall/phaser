...
//------------------------------------------
alans_snackbar.Preloader = function (game) {
...
//------------------------------------
alans_snackbar.Preloader.prototype = {
    ...
    preload: function () {
        ...
        this.load.image('title_page', 'assets/splash/snackbar.png');
        this.load.atlas('play_button', 'assets/toon/play_button.png', 'images/play_button.json');
        this.load.audio('title_music', ['assets/music/main_menu.mp3']);
